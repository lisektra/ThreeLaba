...
open_button1 = tk.Button(root, text='Открыть вариант Николаевой', command=open_program1)
open_button1.pack(padx=20, pady=10)
open_button2 = tk.Button(root, text='Открыть вариант Костиной', command=open_program2)
